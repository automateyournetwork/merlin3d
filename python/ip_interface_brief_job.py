...
$ pyats run job ip_interface_brief_job.py --testbed-file testbed/testbed_DevNet_Nexus9k_Sandbox.yaml
...
def main(runtime):
    ...
    testscript = os.path.join(os.path.dirname(__file__), 'ip_interface_brief.py')
